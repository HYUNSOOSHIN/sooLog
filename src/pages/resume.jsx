    ...
    <Layout>
        ...
        <div id="container-resume">
            ...
            <section className="sideproject">
                ...
                <div className="content-view">
                    <div className="project-item">
                        <div className="flex-view">
                            <h4>PEPSI-MAN</h4>
                            <a href="https://hyunsooshin.github.io/pepsi-man" target="_blank" rel="noreferrer" title="Demo">
                                <i className="fa-solid fa-desktop"></i>
                            </a>
                            <a href="https://github.com/HYUNSOOSHIN/pepsi-man" target="_blank" rel="noreferrer" title="Github">
                                <i className="fa-brands fa-github"></i>
                            </a>
                        </div>

                        <p className="description">가수/래퍼 ZIORPARK 페이지</p>

                        <img src="/images/PEPSI-MAN.png" alt="pepsi-man project img" />

                        <ul>
                            <li>• 미디어 쿼리를 이용한 반응형 웹 구현</li>
                            <li>• 다크모드 적용</li>
                            <li>• Firebase를 이용한 사용자 인증 / 실시간 데이터베이스 적용</li>
                            <li>• Stack: React.js / FireBase(Authentication, FireStore, Storage)</li>
                        </ul>
                    </div>
                </div>
            </section>
            ...
            <section className="education">
                ...
                <div className="content-view">
                    <p>2014.03-2020.02 한성대학교 정보시스템공학과</p>
                </div>
            </section>
        </div>
    </Layout>
